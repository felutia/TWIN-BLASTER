 ...
 *  @since      1.0
 *
 *  Copyright (c) 2015, Riki Ito. All rights reserved.
 */
...
namespace game
{
    ...
    /// ヒットエフェクトクラス
    /// </summary>
    public class CBombEffect
        : IEffect
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public CBombEffect( COLOR_ID color, Vector2 pos )
			: base( color, pos )
        {
        }
		...
		{
			m_EffectID = EFFECT_ID.BOMB_EFFECT;
        ...
        public override void Update( )
        {
            ...
            m_Sprite.Scaling += new Vector2( 0.1f, 0.1f );
