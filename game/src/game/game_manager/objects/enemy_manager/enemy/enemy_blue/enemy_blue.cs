...
namespace game
{
	public class CEnemyBlue:IEnemy
	{
		public CEnemyBlue ( Vector2 pos, float speed, int power, int life, INSTAGE_ID instage_id, OUTSTAGE_ID outstage_id)
		...
		public override void AttackNormal()
		{
			...
			if( m_AttackTimer.IsEnd() == true )
			{
				if( StageLv > 0)
				{
					...
					if( StageLv > 2 )
					{
						CreateBullet( ENEMY_BULLET_ID.NORMAL_BULLET , COLOR_ID.BLUE, false, new Vector2( -20.0f, -15.0f　), 10.0f, 6.0f, 1 );
						CreateBullet( ENEMY_BULLET_ID.NORMAL_BULLET , COLOR_ID.BLUE, false, new Vector2( -20.0f, -15.0f　), -10.0f, 6.0f, 1 );
						...
						{ 
							...
							if( StageLv > 8)
							{
								CreateBullet( ENEMY_BULLET_ID.NORMAL_BULLET , COLOR_ID.BLUE, false, new Vector2( -20.0f, -15.0f　),  20.0f, 6.0f, 1 );
								CreateBullet( ENEMY_BULLET_ID.NORMAL_BULLET , COLOR_ID.BLUE, false, new Vector2( -20.0f, -15.0f　), -20.0f, 6.0f, 1 );
							}
						}
					}
