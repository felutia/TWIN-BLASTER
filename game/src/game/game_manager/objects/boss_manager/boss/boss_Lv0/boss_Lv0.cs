...
namespace game
{
	public class CBossLv0
		: IBoss
	{
		public CBossLv0 ( Vector2 pos, float speed,  int life )
			:base( pos, speed,  life)
		{
		}
		...
		public override void Initialize ()
		{
			...
			for(int i = 0 ;i < 2;++i)
			{
				...
				m_Danmaku[i] =  CreateDanmaku(m_Danmaku[i] , m_DanmakuId[i],DIFFICULTY.VERY_EASY,m_BulletColor[i]);
			}
		}
