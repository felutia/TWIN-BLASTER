...
namespace game
{
    ...
    /// ヒットエフェクトクラス
    /// </summary>
    public class CHitEffect
        : IEffect
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public CHitEffect( COLOR_ID color, Vector2 pos )
			: base( color, pos )
        {
        }
		...
		{
			m_EffectID = EFFECT_ID.HIT_EFFECT;
			
            m_Sprite = CSpriteManager.Create( TEXTURE_ID.H_EFFECT );
        ...
        public override void Update( )
        {
            ...
            m_Sprite.Angle += FMath.Radians( 10.0f );
			
			//Random rand = new Random();
			//float scal = rand.Next( 0.5f );

            m_Sprite.Scaling += new Vector2( 0.2f, 0.2f );
